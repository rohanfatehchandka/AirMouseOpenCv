...
while True:
    ...
    if len(lmList) != 0:
        ...
        # 8. Only index finger is UP: Clicking Mode
        if fingers[1] == 1 and fingers[0] == 0 and fingers[2] == 0 and fingers[3] == 0 and fingers[4] == 0:
            pyautogui.leftClick()
            time.sleep(0.25)
        # Both index and middle fingers are UP: Right Click
        ...
        # All the fingers are UP: Moving Mode
        ...
        if fingers[1] == 1 and fingers[0] == 0 and fingers[2] == 1 and fingers[3] == 1 and fingers[4] == 1:
